    ...
    <div class="flex min-h-screen flex-col bg-white/70 backdrop-blur">
            ...
            <div class="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
                ...
                <nav class="flex items-center gap-6">
                    @if (request()->routeIs('home') || request()->routeIs('about'))
                        <a href="{{ route('home') }}"
                            class="landing-nav-link {{ request()->routeIs('home') ? 'landing-nav-link-active' : '' }}">
                            Home
                        </a>

                        <a href="{{ route('about') }}"
                            class="landing-nav-link {{ request()->routeIs('about') ? 'landing-nav-link-active' : '' }}">
                            About
                        </a>
                    @endif
        ...
        <footer class="border-t border-neutral-800">
            <div class="mx-auto max-w-5xl px-6 py-6 text-center text-sm text-neutral-500">
                &copy; {{ date('Y') }} {{ config('app.name', 'Credify') }}
            </div>
        </footer>
    </div>
</body>
